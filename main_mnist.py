...
flags.DEFINE_string("checkpoint_dir", "checkpoint_mnist", "Directory name to save the checkpoints [checkpoint]")
flags.DEFINE_string("summary_dir", "summary_mnist", "Directory name to save the summaries [checkpoint]")
